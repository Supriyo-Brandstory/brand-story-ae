...
// Route::get('/home-2', 'FrontendController@index', 'home2');
...
Route::get('/blog/{path*}', 'FrontendController@blogRedirect', 'blog.redirect');
Route::get('/blogs/{path*}', 'FrontendController@blogRouter', 'blog.router.plural');
...
Route::get('/ai-seo-agency-mumbai', 'FrontendController@aiSeoAgencyMumbai', 'aiseoagencymumbai');
...
Route::group(['prefix' => '/industries'], function () {
    ...
    Route::get('/digital-marketing-for-automotive', 'FrontendController@digitalMarketingForAutomotive', 'digitalmarketingforautomotive');
    Route::get('/digital-marketing-for-law-firms', 'FrontendController@digitalMarketingForLawFirms', 'digitalmarketingforlawfirms');
});
...
Route::group(['prefix' => '/admin'], function () {
    ...
    Route::middleware('AdminAuth', function () {
        ...
        Route::get('/pages/bulk-upload', 'Admin\AdminPageController@bulkUpload', 'admin.pages.bulk_upload');
        Route::post('/pages/bulk-upload', 'Admin\AdminPageController@processBulkUpload', 'admin.pages.process_bulk_upload');
        ...
        Route::post('/pages/bulk-delete', 'Admin\AdminPageController@bulkDestroy', 'admin.pages.bulk_destroy');
        Route::post('/pages/delete-all', 'Admin\AdminPageController@deleteAll', 'admin.pages.delete_all');
