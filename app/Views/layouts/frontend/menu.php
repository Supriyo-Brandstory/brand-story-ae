        ...
        <ul>
            ...
            <li class="parent-link">
                <div class="d-flex align-itmes-center">
                    <a href="<?= route('about') ?>" class="mlink">About Us </a>
                </div>
            </li>
                    ...
                    <div class="sub-menu-inner">
                        <div class="hire-submenu-row gap-3">
                            <ul class="w-100">
                                ...
                                <li class="d-flex gap-2 align-items-center"><img src="/assets/images/menu/b2b-services.png" alt="Influencer Marketing" width="30" height="30"> <a href="/influencer-marketing-agency-in-dubai/">Influencer Marketing</a></li>
