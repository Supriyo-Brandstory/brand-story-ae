...
<section class="performance-driven sp-50 dm-bg">
    <div class="container">
        <h2 class="text-white mb-lg-5 mb-4 text-md-start text-center">Off-Page SEO Services in Dubai
            <span class="db">to Strengthen Authority & Visibility</span>
        </h2>
        <div class="row">
            <div class="col-lg-6">
                <div class="position-relative mb-lg-0 mb-3 d-lg-block d-none w-100 radius-20">
                    <img class="w-100 radius-20" src="<?= base_url('/assets/images/new-seo/off-page-1.webp') ?>" alt="Off-page SEO Agency in Dubai">
                </div>

                <div class="position-relative img-fluid radius-20 mb-lg-0 mb-3 d-lg-none d-block">
                    <img class="img-fluid radius-20" src="<?= base_url('/assets/images/new-seo/off-page-mob.webp') ?>" alt="Off-page SEO Agency in Dubai">
                </div>
