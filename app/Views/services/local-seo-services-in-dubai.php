...
<section class="sp-80 dm-bg overflow-hidden position-relative border-top border-secondary border-opacity-10">
    <div class="container">
        <h2 class="text-white mb-5 text-md-start text-center">Local SEO Services in Dubai- Drive Qualified Local Traffic</h2>
        <div class="row g-4 justify-content-center">
            <div class="col-lg-3 col-md-6">
                <div class="why-dubai-card">
                    <div class="card-icon-box"><i class="ion-pinpoint"></i></div>
                    <h4 class="mb-3">Highly Targeted Traffic</h4>
                    <p class="text-white fs-18 mb-0 opacity-70">We position your business for location-based keywords so you attract customers who are ready to take action, not just browse.</p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="why-dubai-card">
                    ...
                    <h4 class="mb-3">Stronger Conversion Potential</h4>
                    <p class="text-white fs-18 mb-0 opacity-70">Appearing in Google Maps and local search results connects you with high-intent users, increasing enquiries, calls, and store visits.</p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="why-dubai-card">
                    ...
                    <h4 class="mb-3">Optimised for “Near Me” Searches</h4>
                    <p class="text-white fs-18 mb-0 opacity-70">We structure your website and Google Business Profile to capture “near me” and geo-specific searches that drive immediate engagement.</p>
                    <span class="card-bg-text">03</span>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="why-dubai-card">
                    <div class="card-icon-box"><i class="ion-map"></i></div>
                    <h4 class="mb-3">Local Directory & Map Visibility</h4>
                    <p class="text-white fs-18 mb-0 opacity-70">From GBP optimisation to local citations, we strengthen your presence across authoritative directories that influence local rankings.</p>
