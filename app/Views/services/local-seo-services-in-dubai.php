                    ...
                    <div class="grow-form-main">
                        <div class="site-form form-light">
                            <form id="contact" action="https://www.brandstory.ae/contact/submit" method="post">
                                <input type="hidden" name="_token" value="1b29efaa8a8d2208aab322a406ccb9b8d1cf720360b9bd85a799fa2307bb4c7a">
                                <div class="row">
                                    <div class="col-12">
                                        <label>Name*</label>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="iti iti--allow-dropdown iti--separate-dial-code">
                                            <div class="iti__flag-container">
                                                <div class="iti__selected-flag" role="combobox" aria-owns="country-listbox" tabindex="0" title="United Arab Emirates (‫الإمارات العربية المتحدة‬‎): +971">
                                                    <div class="iti__flag iti__ae"></div>
                                                    <div class="iti__selected-dial-code">+971</div>
                                                    <div class="iti__arrow"></div>
                                                </div>
                                                <ul class="iti__country-list iti__hide" id="country-listbox" aria-expanded="false" role="listbox" aria-activedescendant="iti-item-ae">
                                                    <li class="iti__country iti__preferred iti__active" tabindex="-1" id="iti-item-ae" role="option" data-dial-code="971" data-country-code="ae" aria-selected="true">
                                                    ...
                                                    <li class="iti__country iti__preferred" tabindex="-1" id="iti-item-in" role="option" data-dial-code="91" data-country-code="in">
                                                        <div class="iti__flag-box">
                                                    ...
                                                    <li class="iti__country iti__preferred" tabindex="-1" id="iti-item-sg" role="option" data-dial-code="65" data-country-code="sg">
                                                        <div class="iti__flag-box">
                                            ...
                                            </div><input type="tel" name="phone" id="phone" class="form-control" maxlength="12" minlength="8" pattern="^((\\+91-?)|0)?[0-9]{10,11}$" required="" autocomplete="off" style="padding-left: 93px;">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label>Company*</label>
