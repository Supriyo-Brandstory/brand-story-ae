                ...
                <div class="sem-banner-left">
                    ...
                    <div class="sem-banner-right position-relative d-lg-none mb-5">
                        <div class="laptop-mockup">
                            <img src="<?= base_url('assets/images/new-seo/sem-10.webp') ?>" alt="SEM Performance Dubai" class="img-fluid" fetchpriority="high" loading="eager">
                        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="position-relative mb-lg-0 mb-3 d-lg-block d-none w-100 radius-20">
                    <img class="w-100 radius-20" src="<?= base_url('/assets/images/new-seo/sem-11.webp') ?>" alt="SEM Experts in Dubai">
                
                </div>
                <div class="position-relative img-fluid radius-20 mb-lg-0 mb-3 d-lg-none d-block">
                    <img class="img-fluid radius-20" src="<?= base_url('/assets/images/new-seo/sem-12.webp') ?>" alt="SEM Marketing Agency in Dubai">
        ...
        <div class="row g-4 align-items-stretch">
                ...
                <div class="row g-4 h-100">
                    ...
                    <div class="col-md-6 mb-md-0 mb-4">
                        <div class="sem-service-card">
                            ...
                            <h3 class="fs-24 fw-600">3. High-End PPC Campaign Management</h3>
                    ...
                    <div class="col-md-6">
                        <div class="sem-service-card">
                            ...
                            <h3 class="fs-24 fw-600">4. Analytics & Continuous Optimisation</h3>
            ...
            <div class="col-lg-5">
                <div class="service-right-img h-100">
                    <img src="<?= base_url('/assets/images/new-seo/sem-14.webp') ?>" alt="SEM Experts in Dubai" class="w-100 h-100 radius-20 object-fit-cover shadow-lg" style="min-height: 400px;">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button show fs-24 fw-700" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                1. What does a search engine marketing agency in Dubai do?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingThree">
                            <button class="accordion-button collapsed fs-24 fw-700" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                3. Why is search engine marketing important for businesses?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingSix">
                            <button class="accordion-button collapsed fs-24 fw-700" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                6. What is PPC ads and how does it support business growth?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingNine">
                            <button class="accordion-button collapsed fs-24 fw-700" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                                9. How does BrandStory customise SEM strategies?
                            </button>
                        </h2>
