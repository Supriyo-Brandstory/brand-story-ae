    ...
    <div class="sticky-wrapper">
        ...
        <div class="scroll-slide slide-1 active" id="banner-slide-1">
            <div class="slide-1-content">
                <div class="slide-1-text">
                    <h1>On-Page SEO<br>in Dubai Drives</h1>
                </div>
        ...
        <div class="scroll-slide slide-3 next-slide" id="banner-slide-3">
            <div class="slide-3-content">
                <p class="slide-3-desc">We are a dedicated SEO agency in Dubai, helping businesses optimize their website content, structure, and technical elements to boost search rankings, enhance user experience and conversions.</p>
...
<section class="performance-driven sp-50 dm-bg">
    <div class="container">
        <h2 class="text-white mb-lg-5 mb-4 text-md-start text-center">On-Page SEO Services in Dubai
            <span class="db">to Maximize Website Performance</span>
        </h2>
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6 align-self-center">
                <ul class="mb-0">
                    <li class="text-white mb-3 fs-20">On-page SEO is the foundation of a strong online presence. At BrandStory, we specialize in optimizing every page of your website to improve 
                        search engine visibility and deliver a seamless user experience. From meta tags and headings to images, internal links, and structured data, our experts ensure every 
                        element aligns with SEO best practices.</li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7">
                    <h2 class="text-white mb-4 text-md-start text-center ">What is On-Page SEO?</h2>
                    <p class="fs-20 text-white">
                        Your website can only perform when on-page metrics are properly implemented. On-page SEO is what turns a website into a 
                        search-ready, user-friendly platform that search engines trust and users stay on. It focuses on how each page is structured, 
                        how information is presented, and how effectively search engines can process and rank your content.
                    </p>
                    <p class="fs-20 text-white">
            ...
            <div class="row mt-4 mt-lg-5 border-top ">
                ...
                <div class="col-md-7 mt-5">
                    <p class="fs-20 text-white mb-3">At BrandStory, our on-page SEO optimization services in Dubai are designed to strengthen the core 
                        performance of your website. We focus on refining how each page is structured, interpreted, and ranked by search engines, ensuring
                         your content, technical elements, and user pathways work together seamlessly. Every optimization is aligned with your business
                          objectives, helping your website gain stronger visibility, improved engagement, and consistent organic growth.</p>

                    <p class="fs-20 text-white">
                        By optimizing individual page elements with precision, we help your website move beyond basic compliance and into high-performing 
                        territory. Our on-page SEO approach ensures your website is built to rank, engage, and convert, making it a powerful digital 
