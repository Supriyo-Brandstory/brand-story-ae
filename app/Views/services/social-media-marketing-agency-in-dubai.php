     ...
     <div class="container">
         ...
         <div class="row gy-3 pt-lg-5 pt-3">
             ...
             <div class="col-lg-6 col-12 text-white">
                 ...
                 <p class="mb-3 fs-18 text-white">We turn social media into a growth engine for your business, delivering measurable results that expand your audience across platforms and spark meaningful interactions.</p>
                 <p class="mb-3 fs-18 text-white">We are a skilled team of social media specialists, storytellers, and strategists under one roof. From creating content to executing campaigns, we are a full-package social media marketing agency in Dubai to elevate your social media presence. We craft campaigns that spark conversations, build loyalty, and amplify your brand presence across social media platforms. At BrandStory, <a href="/" style="text-decoration:underline; color:#fff">digital marketing</a> is not just a skill, it's a signature.</p>
     ...
     <script>
         document.querySelectorAll('.strategy-title').forEach(item => {
             item.addEventListener('click', function() {
                 document.querySelectorAll('.strategy-title').forEach(el => el.classList.remove('active'));
                 this.classList.add('active');
                 const strategyClass = Array.from(this.classList).find(cls => cls.startsWith('strategy') && cls !== 'strategy-title');
                 document.querySelectorAll('.strategy-process-main').forEach(el => el.style.display = 'none');
                 document.querySelectorAll('.strategy-process-main.' + strategyClass).forEach(el => el.style.display = 'block');
             });
         });
     </script>
 </section>
             ...
             <div class="service-box-left">
                 ...
                 <div class="stats">
                     ...
                     <div class="stat-box stat-2">
                         ...
                         <div class="info-text">
                             <h5>2-4x</h5>
                             <p class="text-white">Engagement</p>
                         </div>
                     </div>
     ...
     <div class="container">
         ...
         <div class="row gy-3 pt-lg-5 pt-3">
             <div class="col-lg-7 col-12 text-white order-md-1 order-2">
                 <p class="mb-3 fs-18 text-white">Social media is not just about posting content- it’s about purpose, timing, relevance, and strategy. A compelling brand
                 ...
                 <ul style="list-style: none;" class="fs-18 text-white">
                 ...
                 <p class="fs-18 text-white">Whether your goal is rapid follower growth, launching standout campaigns, or creating widespread brand awareness, BrandStory excels at turning everyday
...
<section class="Performance-Driven-wrapper" id="videoSection">
         ...
         <div class="row g-lg-5 g-3 position-relative">
             ...
             <div class="col-lg-7 col-12">
                 <div class="clients-swiper-container">
                     <div class="swiper whatOurClientsSay_Swiper">
                         <div class="swiper-wrapper">
                             <div class="swiper-slide">
                                 ...
                                 <div class="testimoni-name">
                                     <p class="fw-700 fs-24 text-start">– Ahmed K., Tech Startup Founder</p>
                                 </div>
                             </div>
                             <div class="swiper-slide">
                                 <div class="slide-container">
                                 ...
                                 <div class="testimoni-name">
                                     <p class="fw-700 fs-24 text-start">Lina R., Health & Wellness Coach</p>
                                 </div>
                             </div>
                             <div class="swiper-slide">
                                 <div class="slide-container">
                                 ...
                                 <div class="testimoni-name">
                                     <p class="fw-700 fs-24 text-start">– Omar S., Real Estate Developer</p>
                                 </div>
                             </div>
                             <div class="swiper-slide">
                                 <div class="slide-container">
                                 ...
                                 <div class="testimoni-name">
                                     <p class="fw-700 fs-24 text-start">– Maya T., Luxury Lifestyle Brand</p>
                                 </div>
                             </div>
                             <div class="swiper-slide">
                                 <div class="slide-container">
                                 ...
                                 <div class="testimoni-name">
                                     <p class="fw-700 fs-24 text-start">– Khalid A., Financial Services Provider</p>
                                 </div>
                             </div>
                         </div>
             ...
             <div class="swiper-button-wrapper pt-5 pt-lg-0">
                 <div class="swiper-pagination-prev-cust"></div>
                 <div class="swiper-pagination-next-cust"></div>
             </div>
         </div>
     </div>
 </section>
 ...
 <section class="sp-80 bg-black">
     <div class="container">
         ...
         <div class="soc_latest_blogs pt-lg-5 pt-3 position-relative">
                 ...
                 <div class="swiper-wrapper">
                         ...
                         <div class="each_blog_wrapper">
                             ...
                             <div class="content_container_main pt-3">
                                 <div class="text_content">
                                     <h4 class="fs-24 fw-700 text-black">The Best Social Media Channels for your Brand's Marketing</h4>
                     ...
                     <div class="swiper-slide">
                         <div class="each_blog_wrapper">
                             ...
                             <div class="content_container_main pt-3">
                                 <div class="text_content">
                                     <h4 class="fs-24 fw-700 text-black">How Influencer Marketing Can Elevate Your Digital Branding</h4>
                     ...
                     <div class="swiper-slide">
                         <div class="each_blog_wrapper">
                             ...
                             <div class="content_container_main pt-3">
                                 <div class="text_content">
                                     <h4 class="fs-24 fw-700 text-black">Drive Smarter Growth with Digital Marketing Trends in 2025</h4>
                     ...
                     <div class="swiper-slide">
                         <div class="each_blog_wrapper">
                             ...
                             <div class="content_container_main pt-3">
                                 <div class="text_content">
                                     <h4 class="fs-24 fw-700 text-black">7 Key Branding Strategies to Establish a Strong Brand Identity</h4>
                     ...
                     <div class="swiper-slide">
                         <div class="each_blog_wrapper">
                             ...
                             <div class="content_container_main pt-3">
                                 <div class="text_content">
                                     <h4 class="fs-24 fw-700 text-black">Digital Marketing Competitor Analysis: How to Ethically Track Your Competitors</h4>
                     ...
                     <div class="swiper-slide">
                         <div class="each_blog_wrapper">
                             ...
                             <div class="content_container_main pt-3">
                                 <div class="text_content">
                                     <h4 class="fs-24 fw-700 text-black">Digital vs Traditional Marketing: What You Really Needs</h4>
             ...
             <div class="latest_blog_pagination_wrapper">
                 <div class="blog_pgn_prev"></div>
                 <div class="blog_pgn_next"></div>
             </div>
         </div>
     </div>
 </section>
 ...
 <script>
     const smmsOverlay = document.getElementById("smms-popup-overlay");
     const smmsBox = document.querySelector(".smms-popup-box");
     const smmsTitle = document.getElementById("smms-popup-title");
     const smmsDesc = document.getElementById("smms-popup-desc");
     const smmsClose = document.querySelector(".smms-popup-close");

     const descriptions = {
         "Comprehensive Social Media Management": "We take full responsibility for managing your brand's social media presence. From brand-aligned content strategy to creative design and publishing high-performing posts, our expert team ensures that your brand is active and visible on social platforms, driving consistent audience engagement. We create a lead-generating pipeline that transforms your social visibility into conversions.",
         "Custom Campaigns & Social Projects": "Launching a brand-new initiative or looking for a limited-time campaign? Our social media team builds a custom strategy, manages the execution, and drives desired results across all social media channels. Our strategic masterminds make sure your campaigns can create the maximum impact, whether it is a seasonal promotion or a one-time activation.",
         "Strategic Social Media Content Creation": "Your social channels serve as the voice of your brand, and we create that impact. As the name suggests, BrandStory crafts your brand’s unique story aligned with your tone, goals, and audience interests. Whether a trend-driven post, interactive media, or thought leadership, we aim to create each piece of content to drive engagement and brand loyalty.",
         "Targeted Social Media Advertising": "Launching a new product, having big announcements, or wanting to promote your existing services? We design and manage paid social media and high-end programmatic ad campaigns that drive targeted visibility and real results. Starting from the ad setup to real-time monitoring and optimization, our expert team delivers maximum ROI across platforms.",
         "Influencer Collaboration & Partnerships": "We know the value proposition of influencer marketing in social media, and we master that too. We connect you with the niche influencers, manage the strategy, content, outreach, and overall execution from start to finish. With a strong connection with micro and macro influencers in Dubai and the UAE, we build your credibility, drive organic engagement, and increase reach.",
         "Event-Focused Social Media Marketing": "Want to make your event unforgettable? We are here to make it happen online. Whether it's a product launch, trade show, or conference, we manage every aspect with high-end content and marketing. We create pre-event hype, live event updates, and maintain post-event engagement, ensuring it reaches the targeted audience and creates a buzz around social media."
     };

     document.querySelectorAll('.smms-cta a').forEach(link => {
         link.addEventListener('click', function(e) {
             ...
             smmsTitle.innerText = title;
             smmsDesc.innerText = descriptions[title] || "No description available.";
             smmsBox.style.backgroundColor = color || "#5412c7";

             smmsOverlay.classList.remove("d-none");
         });
     });

     smmsClose.addEventListener("click", () => {
         smmsOverlay.classList.add("d-none");
     });

     smmsOverlay.addEventListener("click", (e) => {
         if (e.target === smmsOverlay) {
             smmsOverlay.classList.add("d-none");
         }
     });
 </script>
