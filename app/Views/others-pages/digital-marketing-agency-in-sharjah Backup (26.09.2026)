    ...
    <div class="perks-vide-bg position-relative sp-50 bg-burjkhalifa">
        ...
        <div class="perks-content position-relative">
            <div class="container perkshd position-relative">
                <h2 class="text-center mb-lg-5 mb-4 text-black mt-lg-4">Performance-Focused Digital Marketing <br>Services in Sharjah</h2>
            </div>
    ...
    <div class="container">
        <div class="row gy-4 gy-md-5 gx-md-5">
            <div class="col-md-6 text-md-start text-center">
                <h2>Your Trusted <span class="db"> Digital Marketing</span> Agency in Sharjah</h2>
                <p>Selecting the right digital marketing partner in Sharjah is essential to ensure your brand connects with the 
                    right audience, maximizes ROI, and achieves sustainable growth in a competitive market.</p>
            </div>
            <div class="col-md-6 d-flex align-items-stretch">
                <div class="create-positive-box text-md-start text-center">
                    ...
                    <p>Sharjah’s digital ecosystem is shaped by cultural depth, a strong SME presence, and a rapidly growing online audience. Our team 
                        ...
                        communicate with relevance and clarity across Sharjah’s diverse market.</p>
                </div>
            </div>
            <div class="col-md-6 d-flex align-items-stretch">
                <div class="create-positive-box text-md-start text-center">
                    ...
                    <p>Rather than using generic digital formulas, we create marketing strategies tailored to Sharjah’s business environment. By aligning 
                        ...
                        and scalable growth across channels.</p>
                </div>
            </div>
            <div class="col-md-6 d-flex align-items-stretch">
                <div class="create-positive-box text-md-start text-center">
                    ...
                    <p>Sharjah businesses face unique hurdles from reaching multilingual audiences to standing out in crowded digital spaces. We address these 
                        ...
                        competitive, and performance-oriented over the long term.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample1">
                ...
                <div class="accordion-item">
                    <h4 class="accordion-header" id="flush-headingOne1-1">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne1-1" aria-expanded="false" aria-controls="flush-collapseOne1-1">
                            How Does Digital Marketing Support Business Growth in Sharjah?
                        </button>
                    </h4>
                    <div id="flush-collapseOne1-1" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne1-1" data-bs-parent="#accordionFlushExample1">
                        <div class="accordion-body">
                            <p class="fs-16 mb-0">
                                Digital marketing helps businesses in Sharjah build visibility, attract relevant audiences, and convert interest into leads through a mix of search, social, content, and performance channels.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h4 class="accordion-header" id="flush-headingTwo1-2">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo1-2" aria-expanded="false" aria-controls="flush-collapseTwo1-2">
                            Which Digital Marketing Channels Work Best for Sharjah Businesses?
                        </button>
                    </h4>
                    <div id="flush-collapseTwo1-2" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo1-2" data-bs-parent="#accordionFlushExample1">
                        <div class="accordion-body">
                            <p class="fs-16 mb-0">
                                The most effective channels depend on your industry and goals, but commonly include SEO, social media marketing, paid advertising, content marketing, and email campaigns aligned with Sharjah’s audience behavior.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseThree1-3" class="accordion-collapse collapse" aria-labelledby="flush-headingThree1-3" data-bs-parent="#accordionFlushExample1">
                        <div class="accordion-body">
                            <p class="fs-16 mb-0">
                                Local insights help align campaigns with cultural preferences, language nuances, search behavior, and buying intent, making digital strategies more effective in Sharjah.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapsefour1-4" class="accordion-collapse collapse" aria-labelledby="flush-headingfour1-4" data-bs-parent="#accordionFlushExample1">
                        <div class="accordion-body">
                            <p class="fs-16 mb-0">
                                Timelines vary by channel. Paid campaigns can generate quicker results, while SEO and content marketing build sustained growth over time through consistent optimization.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapsefive1-5" class="accordion-collapse collapse" aria-labelledby="flush-headingfive1-5" data-bs-parent="#accordionFlushExample1">
                        <div class="accordion-body">
                            <p class="fs-16 mb-0">
                                Yes, well-planned digital strategies can target local audiences in Sharjah while also expanding reach across the UAE and wider regional markets.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapsesix1-6" class="accordion-collapse collapse" aria-labelledby="flush-headingsix1-6" data-bs-parent="#accordionFlushExample1">
                        <div class="accordion-body">
                            <p class="fs-16 mb-0">
                                Campaign success is measured through traffic quality, engagement levels, lead generation, conversion performance, and return on investment across platforms.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapsesix1-7" class="accordion-collapse collapse" aria-labelledby="flush-headingsix1-7" data-bs-parent="#accordionFlushExample1">
                        <div class="accordion-body">
                            <p class="fs-16 mb-0">
                                Digital marketing strategies are scalable and can be customized to support startups, growing businesses, and established enterprises with different objectives and budgets.
                            </p>
                        </div>
                    </div>
                </div>
...
<style>
    .bg-burjkhalifa::before {
        ...
        width: 100%;
        height: 100%;
        background: url('/assets/images/new-seo/digital-marketing-sharjah.webp');
