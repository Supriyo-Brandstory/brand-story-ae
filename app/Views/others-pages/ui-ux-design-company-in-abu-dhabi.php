				...
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active" id="spt-1" role="tabpanel"><!--tab1 content start-->
						<div class="process-txt-row">
							...
							<div class="process-tabs-img">
								<img src="/assets/images/service/ui-ux/ui-ux-process-1.png" class="img-fluid" alt="UI UX Design Agency in Abu Dhabi">
							</div>
						</div>
					...
					<div class="tab-pane fade" id="spt-2" role="tabpanel"><!--tab2 content start-->
						<div class="process-txt-row">
							...
							<div class="process-tabs-img">
								<img src="/assets/images/service/ui-ux/ui-ux-process-2.png" class="img-fluid" alt="UI UX Design Company in Abu Dhabi">
							</div>
						</div>
					...
					<div class="tab-pane fade" id="spt-3" role="tabpanel"><!--tab3 content start-->
						<div class="process-txt-row">
							...
							<div class="process-tabs-img">
								<img src="/assets/images/service/ui-ux/ui-ux-process-3.png" class="img-fluid" alt="UI UX Design Services in Abu Dhabi">
							</div>
						</div>
					...
					<div class="tab-pane fade" id="spt-4" role="tabpanel"><!--tab4 content start-->
						<div class="process-txt-row">
							...
							<div class="process-tabs-img">
								<img src="/assets/images/service/ui-ux/ui-ux-process-4.png" class="img-fluid" alt="UI UX Agency in Abu Dhabi">
							</div>
						</div>
					...
					<div class="tab-pane fade" id="spt-5" role="tabpanel"><!--tab5 content start-->
						<div class="process-txt-row">
							...
							<div class="process-tabs-img">
								<img src="/assets/images/service/ui-ux/ui-ux-process-5.png" class="img-fluid" alt="UI UX Company in Abu Dhabi">
							</div>
						</div>
		...
		<div class="row align-items-center"><!--Row Start-->
			<div class="col-md-6"> <!--col start-->
				<div class="best-txt"><!--txt start-->
					<h2>UI UX Design Company in Abu Dhabi</h2>
					<p>At our UI UX Design Company in Abu Dhabi UAE, we work hard to create functional UI/UX designs that align with the business goals. Each aspect of the design is conceived with the end user in mind and everything that affects the user becomes a part of our design process. Our clear-cut, intuitive, and scalable designs strive to capture the user's attention and enhance his browsing experience.</p>
			...
			<div class="col-md-6"> <!--col start-->
				<div class="best-img">
					<img src="/assets/images/seo/ui-ux/ui-ux-abt-abu-dhabi-img.jpg" class="img-fluid" alt="Brandstory AE">
				</div>
			</div><!--col end-->
		</div><!--Row End-->
	</div><!--Container End-->
...
<section class="ui-ux-seo-services sp-50">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h2 class="text-center">Abu Dhabi UI/UX Design Services</h2>
		...
		<div class="row gy-4 gy-md-0">
			<div class="col-md-6 ss-border-right ss-border-bottom parent-position">
				<div class="seo-service-box pe-md-5">
					<img src="/assets/images/seo/ui-ux/ui-ux-abu-dhabi-service-icon-1.png" class="img-fluid" alt="UI UX Studio in Abu Dhabi">
			...
			<div class="col-md-6 ss-border-bottom">
				<div class="seo-service-box ps-md-5">
					<img src="/assets/images/seo/ui-ux/ui-ux-abu-dhabi-service-icon-2.png" class="img-fluid" alt="UI UX Design Studios in Abu Dhabi">
			...
			<div class="col-md-6 ss-border-right">
				<div class="seo-service-box pe-md-5 pt-md-4">
					<img src="/assets/images/seo/ui-ux/ui-ux-abu-dhabi-service-icon-3.png" class="img-fluid" alt="UI UX in Abu Dhabi">
			...
			<div class="col-md-6">
				<div class="seo-service-box ps-md-5 pt-md-4">
					<img src="/assets/images/seo/ui-ux/ui-ux-abu-dhabi-service-icon-4.png" class="img-fluid" alt="UI UX Abu Dhabi">
					<p>Our team of qualified ui/ux designers in abu dhabi are continuously trained to keep abreast with the latest trends and technology in UI/UX design. We have retained our position of being one of the top UI/UX design studios in abu dhabi by offering our clients enhanced services through constant innovation.</p>
				</div>
			</div>
		</div>
	</div>
