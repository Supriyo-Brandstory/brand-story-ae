...
<div class="sp-50 container seo-portfolio-section" id="SEO-campaign-highlights">
    <h2 style="color:#212529" class=" mb-lg-5 mb-4 text-md-start text-center">Where Strategy Meets Success <br>Explore Our Portfolio</h2>
            ...
            <div class="col-md-6 d-flex align-items-stretch"> <!--col start-->
                <div class="sp-serv-box">
                    ...
                    <ul class="seo-pages-list">
                        ...
                        <li>Our SEO services company in Abu Dhabi can understand that identification of keywords is the fundamental step of improving organic search rankings. Our digital marketing experts will perform keyword selection depends on factors such as potential customers, competitors, and search volume.</li>
                        <li>Our SEO firms in Abu Dhabi can help optimize your websites through niche long-tail keywords. We analyse all parts of your website such as site architecture, competitor analysis, malware analysis, website scores, navigation, HTML tags, and identification of more negative SEO features. </li>
                    </ul>
                </div>
            </div><!--col end-->
            <div class="col-md-6 d-flex align-items-stretch"> <!--col start-->
                <div class="sp-serv-box">
                    ...
                    <ul class="seo-pages-list">
                        ...
                        <li>Our SEO consultants in Abu Dhabi will perform off-page optimization strategies focus on implementing tools to measure quality and quantity of inbound links. </li>
                        <li>Our SEO agency in Abu Dhabi teams will work on effective business listings, social bookmarking, article submission, web 2.0 submission, classified submission, backlink profile building, directory listings, forum posting, Q&A submission and more.</li>
                    </ul>
                </div>
            </div><!--col end-->
            <div class="col-md-6 d-flex align-items-stretch"> <!--col start-->
                <div class="sp-serv-box">
                    ...
                    <ul class="seo-pages-list">
                        ...
                        <li>Local search optimization is the first step to ensure your business reaches regional markets. Our SEO experts in Abu Dhabi will ensure that the entries in Google My Business are accurate and up to date. </li>
                        <li>Our SEO Services Company in Abu Dhabi provide services that include company details optimizations like business name optimization, address optimization, business phone number optimization, NAP optimization, image optimization, services optimization, product postings, event postings and more.</li>
                    </ul>
                </div>
            </div><!--col end-->
        </div><!--Row End-->
