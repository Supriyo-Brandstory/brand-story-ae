		...
		<div class="wt-is-pm">
			<div class="row">
				<div class="col-md-6 text-center">
					<img src="/assets/images/service/pm/wt-is-pm.png" class="img-fluid mb-4 mb-lg-0"
						alt="Performance Marketers in Dubai">
				</div>
				<div class="col-md-6">
...
<!--<section class="wt-makes-pm sp-50">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h2 class="text-center mb-5">See what makes Performance Marketing <span class="db">more preferred among
						today’s modern marketers</span></h2>
			</div>
		</div>
		<div class="row gy-3 gy-md-5 gx-md-5">
			<div class="col-md-5">
				<h4 class="text-center wt-makes-color-1">Performance marketing</h4>
				<div class="wt-makes-content-box wmbox1 wt-makes-border-color-1 mt-3">
					<p>Measurable results - advertisers set a specific goal</p>
					<ul class="d-xl-flex justify-content-between">
						<li>Clicks </li>
						<li>Views or sales</li>
						<li>Pay for action </li>
					</ul>
					<p>Getting people to take specific actions</p>
				</div>
			</div>
			<div class="col-md-2 m-auto">
				<h3 class="text-center mt-3 mt-md-5 pt-md-5">Key KPI Difference</h3>
			</div>
			<div class="col-md-5">
				<h4 class="text-center wt-makes-color-2">Brand Marketing</h4>
				<div class="wt-makes-content-box wmbox2 wt-makes-border-color-2 mt-3">
					<p>Build awareness and equity for a company or product. </p>
					<p>Making people aware of and invested in a company or product.</p>
				</div>
			</div>
			<div class="col-md-5">
				<h4 class="text-center wt-makes-color-1">Performance marketing</h4>
				<div class="wt-makes-content-box wmbox3 wt-makes-border-color-1 mt-3">
					<p>Based on a cost-per-action (CPA) model</p>
					<p>Pays the affiliate only when a customer takes the desired action</p>
					<p>More focused on generating conversions.</p>
				</div>
			</div>
			<div class="col-md-2 m-auto">
				<h3 class="text-center mt-3 mt-md-5 pt-md-5">Effective ways to promote products and services online</h3>
			</div>
			<div class="col-md-5">
				<h4 class="text-center wt-makes-color-3">Affiliate Marketing </h4>
				<div class="wt-makes-content-box wmbox4 wt-makes-border-color-3 mt-3">
					<p>Based on a cost-per-click (CPC) model</p>
					<p>Paid every time a customer clicks on an ad</p>
					<p>Create click-throughs on ads</p>
				</div>
			</div>
			<div class="col-md-5">
				<h4 class="text-center wt-makes-color-1">Performance marketing</h4>
				<div class="wt-makes-content-box wmbox5 wt-makes-border-color-1 mt-3">
					<p>Based on a cost-per-action (CPA) model</p>
					<p>Pays the affiliate only when a customer takes the desired action</p>
					<p>More focused on generating conversions.</p>
				</div>
			...
			<div class="col-md-2 m-auto">
				<h3 class="text-center mt-3 mt-md-5 pt-md-5">Effective advertising methods</h3>
			</div>
			<div class="col-md-5">
				<h4 class="text-center wt-makes-color-4">Programmatic Marketing</h4>
				<div class="wt-makes-content-box wt-makes-border-color-4 mt-3">
					<p>Based on a cost-per-click (CPC) model</p>
					<p>Paid every time a customer clicks on an ad</p>
					<p>Create click-throughs on ads</p>
				</div>
						...
						<div class="process-txt-row">
							...
							<div class="process-tabs-img">
								<img src="/assets/images/service/pm/build-pm-img-1.png"
									class="img-fluid" alt="Best Performance Marketing Company in Dubai">
							</div>
						</div>
						...
						<div class="process-txt-row">
							...
							<div class="process-tabs-img">
								<img src="/assets/images/service/pm/build-pm-img-2.png"
									class="img-fluid" alt="Top Performance Marketing Agency in Dubai">
							</div>
						</div>
						...
						<div class="process-txt-row">
							...
							<div class="process-tabs-img">
								<img src="/assets/images/service/pm/build-pm-img-3.png"
									class="img-fluid" alt="Performance Marketing Agencies in Dubai">
							</div>
						</div>
						...
						<div class="process-txt-row">
							...
							<div class="process-tabs-img">
								<img src="/assets/images/service/pm/build-pm-img-4.png"
									class="img-fluid" alt="Performance Marketing Companies in Dubai">
							</div>
						</div>
						...
						<div class="process-txt-row">
							...
							<div class="process-tabs-img">
								<img src="/assets/images/service/pm/build-pm-img-5.png"
									class="img-fluid" alt="Performance Marketing Services in Dubai">
							</div>
						</div>
