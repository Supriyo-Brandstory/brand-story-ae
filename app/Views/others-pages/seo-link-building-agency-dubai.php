    ...
    <div class="container" bis_skin_checked="1">
        ...
        <div class="row" bis_skin_checked="1">
            <div class="col-lg-6" bis_skin_checked="1">
                ...
                <div class=" mb-lg-0 mb-3  radius-20" bis_skin_checked="1">
                    <div class="left-side orbit-section" bis_skin_checked="1">
                        <div class="center" bis_skin_checked="1">SEO</div>
                        <div class="orbit" bis_skin_checked="1">
                            <!-- Placeholder SEO tool icons (simple shapes representing tools) -->
                            <div class="orbit-item" bis_skin_checked="1"><svg viewBox="0 0 24 24">
                                    <circle cx="12" cy="12" r="10" stroke="#845EF7" fill="none" stroke-width="3"></circle>
                                </svg></div>
                            <div class="orbit-item" bis_skin_checked="1"><svg viewBox="0 0 24 24">
                                    <rect x="4" y="4" width="16" height="16" rx="4" stroke="#845EF7" fill="none" stroke-width="3"></rect>
                                </svg></div>
                            <div class="orbit-item" bis_skin_checked="1"><svg viewBox="0 0 24 24">
                                    <path d="M12 2L2 22h20z" stroke="#845EF7" fill="none" stroke-width="3"></path>
                                </svg></div>
                            <div class="orbit-item" bis_skin_checked="1"><svg viewBox="0 0 24 24">
                                    <path d="M12 2v20M2 12h20" stroke="#845EF7" stroke-width="3"></path>
                                </svg></div>
                            <div class="orbit-item" bis_skin_checked="1"><svg viewBox="0 0 24 24">
                                    <path d="M4 4h16v16H4z" stroke="#845EF7" fill="none" stroke-width="3"></path>
                                </svg></div>
                            <div class="orbit-item" bis_skin_checked="1"><svg viewBox="0 0 24 24">
                                    <polygon points="12,2 22,8 22,16 12,22 2,16 2,8" stroke="#845EF7" fill="none" stroke-width="3"></polygon>
                                </svg></div>
                            <div class="orbit-item" bis_skin_checked="1"><svg viewBox="0 0 24 24">
                                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10" stroke="#845EF7" fill="none" stroke-width="3"></path>
                                </svg></div>
                            <div class="orbit-item" bis_skin_checked="1"><svg viewBox="0 0 24 24">
                                    <path d="M2 12h20M12 2v20" stroke="#845EF7" stroke-width="3"></path>
                                </svg></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 align-self-center" bis_skin_checked="1">
...
<section class="sp-50  bg-black">
    <div class="container">
        <h2 class="text-white mb-5">Best Social Media Marketing Services in Dubai, UAE</h2>
