<section class="seo-page-banner seo-banner-abu-dhabi sp-50">
...
<section class="seo-pages-agency sp-50">
    <div class="container"><!--Container Start-->
        <div class="row col-reverse gx-lg-5 align-items-center"><!--Row Start-->
            ...
            <div class="col-md-6"> <!--col start-->
                <img src="/assets/images/seo/seo/abu-dhabi/agency-abudhabi1.png" class="img-fluid mb-3" alt="seo company in abu dhabi">
            </div><!--col end-->
        </div><!--Row End-->

        <div class="row  spt-50 gx-lg-5 align-items-center"><!--Row Start-->
            <div class="col-md-6"> <!--col start-->
                <img src="/assets/images/seo/seo/abu-dhabi/agency-abudhabi2.png" class="img-fluid mb-3" alt="seo agency in abu dhabi">
            </div><!--col end-->
            <div class="col-md-6"> <!--col start-->
            ...
            <div class="col-md-4 col-lg-6 ps-0"> <!--col start-->
                <div class="sp-impact-image">
                    <div class="sp-impact-pic">
                        <img src="/assets/images/seo/seo/abu-dhabi/impact-abudhabi.png" class="img-fluid mb-3" alt="seo services in abu dhabi">
                    </div>
                </div>
            </div><!--col end-->
        ...
        <div class="row mt-5 align-items-stretch"><!--Row Start-->
            <div class="col-md-6 d-flex align-items-stretch"> <!--col start-->
                <div class="sp-serv-box">
                    <img src="/assets/images/seo/seo/abu-dhabi/ss-abudhabi1.jpg" class="img-fluid mb-3" alt="seo companies in abu dhabi">
            ...
            <div class="col-md-6 d-flex align-items-stretch"> <!--col start-->
                <div class="sp-serv-box">
                    <img src="/assets/images/seo/seo/abu-dhabi/ss-abudhabi2.jpg" class="img-fluid mb-3" alt="seo agencies in abu dhabi">
            ...
            <div class="col-md-6 d-flex align-items-stretch"> <!--col start-->
                <div class="sp-serv-box">
                    <img src="/assets/images/seo/seo/abu-dhabi/ss-abudhabi3.jpg" class="img-fluid mb-3" alt="seo services company in abu dhabi">
            ...
            <div class="col-md-6 d-flex align-items-stretch"> <!--col start-->
                <div class="sp-serv-box">
                    <img src="/assets/images/seo/seo/abu-dhabi/ss-abudhabi4.jpg" class="img-fluid mb-3" alt="seo in abu dhabi">
            ...
            <div class="accordion-item"><!--Accordion item start-->
                ...
                <div id="fc1" class="accordion-collapse collapse show" data-bs-parent="#accordionDM">
                    <div class="accordion-body">
                        <p>Yes, The purpose of Landing Page Optimization is to ensure that when people search for those keywords, your site is one of the first results they see. Our team works on optimizing your landing pages to ensure that the right visitors are seeing your content. Our specialists will help you to identify and target the right keywords, craft an effective message, and create a user-friendly layout. We use the latest techniques to improve page speed, load times, and overall user experience.</p>
                    </div>
                </div>
