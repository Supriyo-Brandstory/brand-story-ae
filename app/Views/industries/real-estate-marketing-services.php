        ...
        <div class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <div class="ppc-service-card" onclick="window.location.href='/industries/real-estate-ui-ux-design-agency-in-dubai-uae'" style="cursor:pointer;">
                ...
                <!-- Service 2 -->
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="ppc-service-card" onclick="window.location.href='/industries/real-estate-branding-agency-in-dubai-uae'" style="cursor:pointer;">
                        <div class="ppc-stack-icon-wrap">
                            <img src="/assets/images/additional-icon-1.svg" class="ppc-main-icon" alt="Geo-Targeting">
                            <div class="card-num-badge">2</div>
                        </div>
                        <div class="ppc-card-body">
                            <h6>Real Estate Branding</h6>
                            <div class="card-arr-btn">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M5 12h14M12 5l7 7-7 7"></path>
                                </svg>
                ...
                <!-- Service 3 -->
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="ppc-service-card" onclick="window.location.href='/industries/real-estate-video-production-agency-in-dubai-uae'" style="cursor:pointer;">
                        <div class="ppc-stack-icon-wrap">
                ...
                <!-- Service 4 -->
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="ppc-service-card" onclick="window.location.href='/industries/real-estate-content-marketing-agency-in-dubai-uae'" style="cursor:pointer;">
                        <div class="ppc-stack-icon-wrap">
                ...
                <!-- Service 5 -->
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="ppc-service-card" onclick="window.location.href='/industries/real-estate-creative-advertising-agency-in-dubai-uae'" style="cursor:pointer;">
                        <div class="ppc-stack-icon-wrap">
                ...
                <!-- Service 6 -->
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="ppc-service-card" onclick="window.location.href='/real-estate-logo-design-agency-in-dubai-uae'" style="cursor:pointer;">
                        <div class="ppc-stack-icon-wrap">
                ...
                <!-- Service 7 -->
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="ppc-service-card" onclick="window.location.href='/industries/real-estate-market-research-agency-in-dubai-uae'" style="cursor:pointer;">
                        <div class="ppc-stack-icon-wrap">
                ...
                <!-- Service 8 -->
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="ppc-service-card" onclick="window.location.href='/industries/real-estate-lead-generation-campaigns-dubai-uae'" style="cursor:pointer;">
                        <div class="ppc-stack-icon-wrap">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                <div class="ppc-service-card" onclick="window.location.href='/industries/real-estate-3d-virtual-property-tours-dubai-uae/'" style="cursor:pointer;">
                    <div class="ppc-stack-icon-wrap">
                        <img src="/assets/images/additional-icon-1.svg" class="ppc-main-icon" alt="3D Virtual Tours">
                        <div class="card-num-badge">9</div>
                    </div>
                    <div class="ppc-card-body">
                        <h6>3D Virtual Tours</h6>
                        <div class="card-arr-btn">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M5 12h14M12 5l7 7-7 7"></path>
                            </svg>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="ppc-service-card" onclick="window.location.href='/industries/real-estate-whatsapp-chatbot-marketing-dubai-uae/'" style="cursor:pointer;">
                    <div class="ppc-stack-icon-wrap">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="ppc-service-card" onclick="window.location.href='/industries/real-estate-reputation-management-agency-dubai-uae/'" style="cursor:pointer;">
                    <div class="ppc-stack-icon-wrap">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="ppc-service-card" onclick="window.location.href='/industries/real-estate-influencer-marketing-agency-dubai-uae/'" style="cursor:pointer;">
                    <div class="ppc-stack-icon-wrap">
