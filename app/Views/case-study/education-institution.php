...
<!--<section class="cs-metrics-sec">
    <div class="container">
        ...
        <div class="cs-metrics-grid">
            ...
            <div class="cs-metric-pill">+127% Growth in Organic Traffic</div>
            <div class="cs-metric-pill cs-dark">6x Increase in Google Clicks</div>
            <div class="cs-metric-pill">300+ Keywords Ranked</div>

            <div class="cs-metric-pill cs-dark">Top Positions Achieved</div>
