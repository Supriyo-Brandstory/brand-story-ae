        ...
        <div class="row g-4">
            <div class="col-md-4 d-flex">
                <div class="scope-main text-center w-100">
                    <img class="mb-lg-5 mb-3" src="/assets/images/cs-spectrum/scope1.png">
                    <h3 class="mb-0 text-white">UI/UX Design</h3>
                </div>
            </div>
            <div class="col-md-4 d-flex">
                <div class="scope-main text-center w-100">
                    <img class="mb-lg-5 mb-3" src="/assets/images/cs-spectrum/scope2.png">
                    <h3 class="mb-0 text-white">Development</h3>
                </div>
            </div>
            <div class="col-md-4 d-flex">
                <div class="scope-main text-center w-100">
                    <img class="mb-lg-5 mb-3" src="/assets/images/cs-spectrum/scope3.png">
                    <h3 class="mb-0 text-white">SEO & Content Strategy</h3>
                </div>
            </div>
        </div>
    </div>
...
<section class="sp-50">
    <div class="container">
        <h2 class="mb-3 text-md-start text-center">Clear Service Architecture for <span class="text-purple">Client <span class="db">Navigation</span></span></h2>
...
<section class="sp-50">
    <div class="container">
        <h2 class="mb-3 text-md-start text-center">Setting a <span class="text-purple">New Standard</span></h2>
        <p class="fs-20 mb-3 text-md-start text-center">Our collaboration with Leading Consulting Firm underscores our ability to build professional, conversion-focused digital platforms in high-trust sectors. The project stands as a testament to our commitment to precision, scalability, and excellence in execution.</p>
    </div>
</section>
